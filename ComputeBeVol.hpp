...
namespace project
{
	...
	public:
		...
		/*
		beVolatilityComputation(underlying undl, double rt);
		//overload with a vector for rates
		beVolatilityComputation(underlying undl, std::vector<double> rt);
		*/
		//read methods
		...
		//need an overload for midpoint because of rate?
		~beVolatilityComputation();
